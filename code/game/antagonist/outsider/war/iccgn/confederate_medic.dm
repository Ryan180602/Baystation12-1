GLOBAL_DATUM_INIT(iccgn_medic, /datum/antagonist/iccgn/medic, new)

/datum/antagonist/iccgn/medic
	id = MODE_ICCGN_MEDIC
	role_text = "Confederate Field Medic"
	antag_indicator = "hudiccgn_medic"
